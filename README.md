...
Grab the RP2040 .uf2 from circuitpython page, hold the bootsel button on the board and plug it in to your pc, and copy the .uf2 to the `PI-RP2` drive to get circuitpython running.
